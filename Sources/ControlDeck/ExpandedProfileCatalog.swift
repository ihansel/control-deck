...
extension ControllerProfile {
    ...
    static let meetings = ControllerProfile(
        ...
        bindings: mapping([
            ...
            .l2: .meetingPushToTalk, .r2: .screenshotSelection,
    ...
    static let figma = ControllerProfile(
        ...
        bindings: mapping([
            ...
            .l1: .undo, .r1: .redo,
            .l2: .mouseRightClick, .r2: .mouseLeftClick,
    ...
    static let videoEditing = ControllerProfile(
        ...
        bindings: mapping([
            ...
            .l2: .timelineReverse, .r2: .timelineForward,
    ...
    static let logic = ControllerProfile(
        ...
        bindings: mapping([
            ...
            .l2: .systemDictation, .r2: .timelineRecord,
